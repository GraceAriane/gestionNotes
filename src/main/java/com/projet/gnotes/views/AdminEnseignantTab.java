...
import com.projet.gnotes.controllers.EnseignantController;
import com.projet.gnotes.models.Utilisateur;
import javafx.geometry.*;
import javafx.scene.control.*;
import javafx.scene.layout.*;

public class AdminEnseignantTab extends VBox {
    public AdminEnseignantTab() {

        TableView<Utilisateur> table = new TableView<>();
        table.setPrefWidth(650);
        EnseignantController controller = new EnseignantController(table);
        ...
        TableColumn<Utilisateur, String> colDiscipline = new TableColumn<>("Discipline");
        colDiscipline.setCellValueFactory(e -> new javafx.beans.property.SimpleStringProperty(e.getValue().getDiscipline()));

        TableColumn<Utilisateur, String> colGrade = new TableColumn<>("Grade");
        colGrade.setCellValueFactory(e -> new javafx.beans.property.SimpleStringProperty(e.getValue().getGrade()));
        ...
        table.getColumns().addAll(colMat, colNom, colPrenom,colDiscipline, colGrade, colActions);
